    ...
    <div style="width: 100%; max-width: 420px;">
        ...
        <div style="text-align: center; margin-bottom: 24px;">
            <a href="{{ route('home') }}" style="display: inline-flex; align-items: center; gap: 10px; text-decoration: none;">
                <img src="{{ asset('logo.png') }}" alt="NEAR JOB" style="width: 46px; height: 46px; border-radius: 14px; object-fit: contain; box-shadow: 0 4px 16px rgba(0,0,0,.15); border: 1px solid rgba(0,0,0,0.1);">
                <span style="font-size: 24px; font-weight: 900; color: #000000; letter-spacing: -0.02em;">NEAR JOB</span>
            </a>
        </div>
        ...
        <div style="background: #ffffff; border-radius: 28px; padding: 32px 28px; box-shadow: 0 20px 50px rgba(15,23,42,0.1); border: 1px solid #e2e8f0; position: relative; overflow: hidden;">
            ...
            <div style="text-align: center; margin-bottom: 24px;">
                <h1 style="font-size: 22px; font-weight: 900; color: #000000; line-height: 1.3; margin: 0 0 6px;">
                    Masuk ke Akun Anda
                </h1>
                <p style="font-size: 12px; color: rgba(0,0,0,0.6); font-weight: 400; margin: 0;">
            ...
            <div style="margin-bottom: 18px;">
                <a href="{{ route('auth.google') }}"
                   style="width: 100%; height: 48px; background: #ffffff; color: #1e293b; font-weight: 800; border-radius: 14px; font-size: 13.5px; display: flex; align-items: center; justify-content: center; gap: 10px; border: 1px solid rgba(0,0,0,0.2); box-shadow: 0 2px 8px rgba(0,0,0,0.04); text-decoration: none; cursor: pointer; transition: all .2s;">
            ...
            <form wire:submit="login" style="display: flex; flex-direction: column; gap: 14px;">
                <div>
                    ...
                    <input type="email" wire:model="email" id="login-email"
                        style="width: 100%; padding: 12px 14px; background: #f8fafc; border: 1px solid rgba(0,0,0,0.2); border-radius: 12px; font-size: 13.5px; font-weight: bold; color: #000000; outline: none; box-sizing: border-box;"
            ...
            <div style="margin-top: 20px; padding-top: 16px; border-top: 1px solid #f1f5f9; text-align: center; display: flex; flex-direction: column; gap: 8px;">
                <div style="font-size: 13px; color: rgba(0,0,0,0.6); font-weight: 400;">
                    Belum punya akun? 
                ...
                <div>
                    <a href="{{ route('home') }}" style="font-size: 12.5px; color: rgba(0,0,0,0.5); font-weight: 500; text-decoration: underline;">
